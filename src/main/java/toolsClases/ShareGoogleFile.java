...
public class ShareGoogleFile
{
    ...
    public static Permission createPublicPermission(String googleFileId) throws IOException
    {
        ...
        return myDriveService.permissions().create(googleFileId, newPermission).execute();
    }

    public static Permission createPermissionForEmail(String googleFileId, String googleEmail)
        throws IOException
    {
        // All values: user - group - domain - anyone
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        String googleEmail = "shkirmantsev@gmail.com";
